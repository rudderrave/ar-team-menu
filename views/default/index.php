...
use arteam\menu\assets\MenuAsset;
use yii\bootstrap\Alert;

/* @var $this yii\web\View */
/* @var $searchModel arteam\menu\models\search\SearchMenu */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title                   = Yii::t('arteam/menu', 'Menus');
...
<div class="menu-index">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <?= Html::a(Yii::t('arteam/menu', 'Add New Menu'), ['/menu/default/create'], ['class' => 'btn btn-sm btn-primary']) ?>
            <?= Html::a(Yii::t('arteam/menu', 'Add New Link'), ['/menu/link/create'], ['class' => 'btn btn-sm btn-primary']) ?>
            ...
            <?= Alert::widget([
                ...
                'body' => Yii::t('arteam/menu', 'An error occurred during saving menu!'),
            ]) ?>
            
            <?= Alert::widget([
                'options' => ['class' => 'alert-info menu-link-alert'],
                'body' => Yii::t('arteam/menu', 'The changes have been saved.'),
            ]) ?>
        </div>
    </div>
