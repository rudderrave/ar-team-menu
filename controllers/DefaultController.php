...
{
    public $modelClass = 'arteam\models\Menu';
    public $modelSearchClass = 'arteam\menu\models\search\SearchMenu';
    public $modelLinkSearchClass = 'arteam\menu\models\search\SearchMenuLink';
